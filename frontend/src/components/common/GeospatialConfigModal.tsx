...
export const GeospatialConfigModal: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/75 backdrop-blur-xs font-mono select-none">
      <div className="w-full max-w-lg bg-[#080D17] border border-[#162136] rounded shadow-2xl overflow-hidden flex flex-col">
        {/* Modal Header */}
        <div className="h-12 px-4 bg-[#05070B] border-b border-[#162136] flex items-center justify-between">
        ...
        <div className="p-5 space-y-4 text-[11px]">
          ...
          <div className="p-3 bg-[#131B2A] border border-[#FFB703]/40 rounded text-[9.5px] text-[#F8FAFC] space-y-1">
            <div className="flex items-center gap-1.5 text-[#FFB703] font-bold uppercase">
          ...
          <div className="space-y-1.5">
            ...
            <select
              ...
              className="w-full px-3 py-2 bg-[#0A1E30] border border-[#162136] text-[#F8FAFC] text-xs focus:outline-none focus:border-[#FFB703]/60 rounded-xs cursor-pointer"
            >
            ...
            <div className="space-y-1.5">
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className="text-[9px] text-[#FFB703] hover:underline cursor-pointer"
                >
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-3 py-2 bg-[#0A1E30] border border-[#162136] text-[#F8FAFC] text-xs font-mono focus:outline-none focus:border-[#FFB703]/60 rounded-xs"
                />
              </div>
              <div className="text-[8.5px] text-[#94A3B8]">
                API keys are kept in your local session and can also be permanently configured via <code className="text-[#FFB703]">.env</code> (<code className="text-[#F8FAFC]">VITE_MAPBOX_TOKEN</code>).
              </div>
            </div>
          ) : (
            <div className="p-2.5 bg-[#05070B] border border-[#162136] rounded text-[9.5px] text-[#94A3B8] flex items-center gap-2">
          ...
          {testResult && (
            <div
              className={`p-2.5 border rounded text-[9.5px] flex items-center gap-2 ${
                testResult.success
                  ? 'bg-[#131B2A] border-[#FFB703]/60 text-[#FFB703]'
          ...
          <div className="p-3 bg-[#05070B] border border-[#152E4D] rounded text-[8.5px] text-[#94A3B8] space-y-1">
        ...
        {/* Modal Footer */}
        <div className="h-14 px-5 bg-[#05070B] border-t border-[#162136] flex items-center justify-between">
          <button
            onClick={handleTest}
            disabled={isTesting}
            className="px-3 py-1.5 bg-[#0A1E30] border border-[#162136] hover:border-[#FFB703]/50 text-[#F8FAFC] text-xs font-bold cursor-pointer rounded-xs transition-colors"
          >
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              onClick={handleSave}
              className="px-4 py-1.5 bg-[#FFB703] text-[#05070B] font-black text-xs cursor-pointer hover:brightness-110 active:scale-95 transition-all shadow-[0_0_12px_rgba(255, 183, 3, )] rounded-xs"
            >
              SAVE CONFIGURATION
            </button>
          </div>
