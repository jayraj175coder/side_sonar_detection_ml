    ...
    <div className="space-y-4 font-sans select-none text-xs">
      ...
      <div className="p-3.5 subpixel-card rounded-2xl border border-white/[0.08] flex flex-col md:flex-row md:items-center justify-between gap-3 shadow-xl">
        <div className="flex flex-wrap items-center gap-3">
          ...
          <span className="text-slate-400 text-xs hidden lg:inline font-mono">
            SURVEY: <strong className="text-[#00F5D4]">NIOT/INCOIS MULTI-BEAM EEZ TRACK</strong>
          </span>
        </div>
        ...
        <div className="flex items-center gap-3 shrink-0">
          {status === 'KEY_MISSING' ? (
            ...
            <div className="flex items-center gap-2">
              <span className="text-[#00F5D4] font-bold text-xs">✓ BASEMAP ACTIVE (Esri Marine)</span>
              <button
                onClick={openModal}
                className="px-3 py-1.5 bg-white/[0.04] hover:bg-white/[0.08] border border-white/[0.1] text-slate-200 font-bold text-xs rounded-xl cursor-pointer transition-all"
              >
      ...
      <div className="p-3 subpixel-card rounded-2xl border border-white/[0.08] flex flex-col lg:flex-row lg:items-center justify-between gap-3 shadow-lg">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 flex-1">
          <div className="flex items-center gap-2 px-3 py-1.5 bg-white/[0.02] border border-emerald-500/20 rounded-xl">
          ...
          <div className="flex items-center gap-2 px-3 py-1.5 bg-white/[0.02] border border-cyan-500/20 rounded-xl">
          ...
          <div className="flex items-center gap-2 px-3 py-1.5 bg-white/[0.02] border border-purple-500/20 rounded-xl">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        <div className="p-3.5 subpixel-card rounded-2xl border border-white/[0.08] flex items-center gap-3 shadow-md">
          <div className="w-10 h-10 bg-white/[0.03] border border-white/[0.08] rounded-xl flex items-center justify-center text-[#38BDF8] shrink-0">
          ...
          <div>
            ...
            <span className="text-xs text-[#38BDF8] block font-semibold">Mumbai Continental Shelf</span>
          </div>
        </div>

        <div className="p-3.5 subpixel-card rounded-2xl border border-white/[0.08] flex items-center gap-3 shadow-md">
          <div className="w-10 h-10 bg-white/[0.03] border border-white/[0.08] rounded-xl flex items-center justify-center text-sky-400 shrink-0">
          ...
          <div>
            ...
            <span className="text-xs text-sky-400 block font-semibold">75m Swath Width</span>
          </div>
        </div>

        <div className="p-3.5 subpixel-card rounded-2xl border border-white/[0.08] flex items-center gap-3 shadow-md">
          <div className="w-10 h-10 bg-white/[0.03] border border-white/[0.08] rounded-xl flex items-center justify-center text-[#00F5D4] shrink-0">
            <Layers className="w-5 h-5" />
          </div>
          <div>
            <span className="text-[10px] text-slate-400 font-bold uppercase tracking-wider block">VERIFIED TARGETS</span>
            <strong className="text-sm font-extrabold text-[#00F5D4] font-mono">10 VERIFIED</strong>
